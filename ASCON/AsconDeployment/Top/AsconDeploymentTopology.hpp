// ======================================================================
// \title  AsconDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef ASCONDEPLOYMENT_ASCONDEPLOYMENTTOPOLOGY_HPP
#define ASCONDEPLOYMENT_ASCONDEPLOYMENTTOPOLOGY_HPP
// Included for access to AsconDeployment::TopologyState and AsconDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <AsconDeployment/Top/AsconDeploymentTopologyDefs.hpp>

// Remove unnecessary AsconDeployment:: qualifications
 ...
 * AsconDeployment::TopologyState see: AsconDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type AsconDeployment::TopologyState see: AsconDeploymentTopologyDefs.hpp.
 *
