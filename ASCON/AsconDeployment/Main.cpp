...
#include <AsconDeployment/Top/AsconDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    AsconDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    AsconDeployment::TopologyState inputs;
    ...
    AsconDeployment::setupTopology(inputs);
    AsconDeployment::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    AsconDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
